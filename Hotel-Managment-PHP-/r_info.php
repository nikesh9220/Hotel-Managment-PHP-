        ...
        <div id="main">
            ...
            <div id='room_info'>
                ...
                if ($con) {
                    ...
                    echo "<div><h2><p align='center'><font color='#ff8040'>Rooms detail:</fonT></p></h2><br>";
			...
			<th>Price</th></blink>
                    ...
                    while ($row = mysql_fetch_array($result)) {
                        ...
                        echo "<td align='center'>" . $row['Rm_type'] . "</td>";
                        echo "<td align='center'>" . $row['Rm_No_bed'] . "</td>";
                        echo "<td align='center'>" . $row['Rm_price'] . "</td>";
                        echo "</tr>";
                    }
