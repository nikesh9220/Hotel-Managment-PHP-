    ...
    <div id="header">
        ...
        <div id="main">
            ...
            <div id='room_info'>
                ...
                echo "<div><h2><p align='center'><font color='#ff8040'>Manage rooms</fonT></p></h2><br>";
                $con = mysql_connect('localhost', 'root', '');
                if ($con) {
                    mysql_select_db("hms", $con);
                    ...
                    echo "<p align='center'><a href='edit_r_detail.php?action=new' style='color:maroon;'>Create New Room</a></p>";
