    ...
    <div>
        ...
        <div id="main" style='padding-top:50px'>
            ...
            <div id="room_info">
                ...
                <?php
                echo "<div><h2><p align='center'><font color='#ff8040'>Manage Customers</fonT></p></h2><br>";
                ...
                echo "<p align='center'><a href='customer_all.php?action=new' style='color:maroon;'>Create New Customer</a></p>";
