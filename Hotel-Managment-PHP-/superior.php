...
<div id="bg_top">
    ...
    <div id="header">
        ...
        <div id="main">
            ...
            <div class="row">
                <h1 style="padding-left:360px; color:#FFBF00">superior</h1>
                <div class="box_img">
                    <a href="javascript:void(viewer.show(0))"><img src="images/superior/sp3.jpg" height="175"
                                                                   width="260" alt=""/></a>
                ...
                <div class="box_img">
                    <a href="javascript:void(viewer.show(0))"><img src="images/superior/sp4.jpg" height="175"
                                                                   width="260" alt=""/></a>
                    <div style="height: 7px;"></div>
                    <div style="height: 5px;"></div>
                </div>
                ...
                <div class="box_img">
                    <a href="javascript:void(viewer.show(0))"><img src="images/superior/sp6.jpg" height="175"
                                                                   width="260" alt=""/></a>
                    <div style="height: 7px;"></div>
                    <div style="height: 5px;"></div>
                </div>
            ...
            <script type="text/javascript">
                ...
                viewer.add('images/superior/sp1.jpg');
                viewer.add('images/superior/sp2.jpg');
                viewer.add('images/superior/sp3.jpg');
                viewer.add('images/superior/sp4.jpg');
                viewer.add('images/superior/sp5.jpg');
                viewer.add('images/superior/sp6.jpg');
                viewer.add('images/superior/sp7.jpg');
                viewer.add('images/superior/sp8.jpg');
                viewer.add('images/superior/sp9.jpg');
                viewer.add('images/superior/sp10.jpg');
                viewer.add('images/superior/sp11.jpg');
                viewer.add('images/superior/sp12.jpg');
                viewer.add('images/superior/sp13.jpg');
                viewer.add('images/superior/sp14.jpg');
                viewer.add('images/superior/sp15.jpg');
                viewer.add('images/superior/sp16.jpg');
                viewer.add('images/superior/sp17.jpg');
            ...
            <div class="row">
                ...
                <div class="box_img">
                    ...
                    <font style="color:#ffffff">
                        <p>Superior rooms are situated on lower floors with very limited views.
                            These light, airy rooms are decorated in colors inspired by the beach and have charming
                            plantation-style shutters.
                            Comfortable work desk</p>
                        <p>
                            Furnished in contemporary Thai style, Superior rooms offer ample facilities, such as
                            satellite TV, minibar, international calls by operator, shower over bath and a
                            hairdryer.</p></font>
                    <div style="height: 7px;"></div>
                    <div style="height: 5px;"></div>
                </div>
