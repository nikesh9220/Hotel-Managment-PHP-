    ...
    <div id="header">
                    ...
                    <div id="form-content">
                        ...
                        <div class="group">
                            ...
                            <div><input id="cin" name="cin" class="form-control" type="date" value="<?php echo $cin; ?>"
                                        placeholder="cin" required></div>
                        </div>
                        <div class="group">
                            <label for="cout">Check out</label>
                            <div><input id="cout" name="cout" class="form-control" type="date"
                                        value="<?php echo $cout; ?>" placeholder="cout" required></div>
                        </div>
      ...
      (select rd.room_no from reservation_detail as rd inner join re_master as rm on rd.r_id=rm.r_id where rm.Check_out<='$check_in'))");
                    if (mysql_num_rows($query) > 0) {
						...
						<td><div><input type='textbox' name='person[" . $row['Room_no'] . "]'></div></td></tr>";
                            //$_SESSION['rno']=$row['Room_no'];
                        }
                        echo "<tr><td><div class='group submit'><input style='margin:20px' type='submit' name='book' value='Book'></div></td></tr>";
            ...
            if (isset($_POST['book'])) {
                if (isset($_POST['rno'])) {
                    ...
                    ?>
                    <center>
                        <form action='payment.php' class="booking-form" method='POST'>
                            <div class="h1">Bill Details</div>
                            <div id="form-content">
                                <div class="group">
                                    <label for="name">Name</label>
                                    <div style="margin-right: 20px;"><input id="name" name="name" class="form-control"
                                ...
                                <div class="group">
                                    ...
                                    <div style="margin-right: 20px;"><input id="no" name="no" class="form-control"
                                                                            type="text" placeholder="Mobile no"
                                                                            value="<?php echo $_SESSION['no']; ?>"
                                                                            readonly="readonly"></div>
                                </div>
                                <div class="group">
                                    <label for="email">Email</label>
                                    <div style="margin-right: 20px;"><input id="email" name="email" class="form-control"
                                ...
                                <div class="group">
                                    ...
                                    <div style="margin-right: 20px;"><input id="name" name="address"
                                ...
                                <div class="group">
                                    ...
                                    <div style="margin-right: 20px;"><input id="city" name="city" class="form-control"
                                ...
                                <div class="group">
                                    ...
                                    <div style="margin-right: 20px;"><input id="state" name="state" class="form-control"
                                ...
                                <div class="group">
                                    ...
                                    <div style="margin-right: 20px;"><input id="postal" name="postal"
                                                                            class="form-control" type="text"
                                                                            placeholder="Postal"
                                                                            value="<?php echo $_SESSION['postal']; ?>"
                                                                            readonly="readonly"></div>
                                </div>
                                <div class="group">
                                    <label for="room">Selected Room(s)</label>
                                    <div style="margin-right: 20px;"><input id="room" name="room" class="form-control"
                                                                            type="text" placeholder="Postal"
                                                                            value="<?php
                                                                            foreach ($rno as $key => $v) {
                                                                                echo $v . " ";
                                                                            }
                                                                            ?>" readonly="readonly"></div>
                                </div>
                                <div class="group">
                                    ...
                                    <div style="margin-right: 20px;"><input id="amt" name="amt" class="form-control"
                                                                            type="text" placeholder="Total amount"
                                                                            value="<?php
                                                                            $total = 0;
                                                                            foreach ($rno as $key => $v) {
                                                                                $result = mysql_query("select Rm_price from room_detail where Room_no='" . $v . "'");
                                ...
                                <div class="group submit">
                                    ...
                                    <div><input name="pay" type="submit" value="Proceed to Pay"/></div>
                                </div>
                            </div>
                    ...
                    echo "<script language='javascript'>window.open('reservation1.php','_top')</script>";
                }
            }
