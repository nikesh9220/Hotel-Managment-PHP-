...
<div id="bg_top">
    ...
    <div id="header">
        ...
        <body>
        <div id='main'>
            <h1><b>The Sunrise Hotel</b></h1>
            <br><br>
            <div style='margin:10px;'>
                <div style="width:400px;">
                    The Sunrise Hotel is a boutique hotel located on Toronto, Canada.
                    The Hotel is within ideal proximity to corporate houses, business parks as well as malls,
                    multiplexes and shopping arcades.
                    There are 33 brilliantly designed rooms that offers comfort with luxury.
                    There are two room categories, Deluxe Rooms and Superior Rooms.
            ...
            <div style='margin:10px;'>
                ...
                <div>
                    <p>
                        The Sunrise Hotel offers you a Futuristic Conference Hall and Business Center to make your
                        meeting a striking success. It is equipped with the state-of-the-art facilities like LCD
                        projectors and sound & light systems, which are ideal for conferences, corporate meetings,
                        seminars and workshops for up to 20 to 200 people. Enchant yourself with amazing ambience and
                        scrumptious food from our Restaurant- The Spice Garden.
                    </p>
                </div>
            </div>
            <!-- bottom begin -->
                    ...
                    <div id="bottom_all">
                        <div id="bottom_all_bot">
                            ...
                            <div id="b_col4">
                                ...
                                malls, multiplexes and shopping arcades.
